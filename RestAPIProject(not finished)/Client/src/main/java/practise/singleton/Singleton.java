...
public class Singleton {
    ...
    private HttpURLConnection sock;
    ...
    private Singleton() {
        ...
        try {
            sock =  (HttpURLConnection) new URL("http://localhost:2024").openConnection();
    ...
    public HttpURLConnection getSock() {
        return sock;
    }
    public void setSock(HttpURLConnection sock, String requestType) throws ProtocolException {
        this.sock = sock;
        this.sock.setRequestMethod(requestType);
        this.sock.setRequestProperty("Content-Type", "application/json");
