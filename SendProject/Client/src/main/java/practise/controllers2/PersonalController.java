...
public class PersonalController implements Initializable {
    ...
    public void OnReload() {
        ...
        for(String i : resultSet) {
            ...
            try {
                observableList.add(new PersonalItems(resultSubSet[0], resultSubSet[1], resultSubSet[2], resultSubSet[3],
                        resultSubSet[4], resultSubSet[5], resultSubSet[6]));
            }
            catch (Exception e) {
    ...
    public void OnDeleteButton(ActionEvent event) {
        String[] arrStr = {"DeletePersonal", Singleton.getInstance().getFinal_NameSername()};
