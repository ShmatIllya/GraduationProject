...
public class PersonalAddController implements Initializable {
    ...
    public void OnSubmitButton() throws IOException {
        ...
        if (!passwordField.getText().equals(password2Field.getText())) {
            ...
            String[] arrStr = {"AddPersonal", loginField.getText(), passwordField.getText(), nameField.getText()
            ...
            String tempString = (String) Singleton.getInstance().getDataController().AddPersonal(arrStr);
