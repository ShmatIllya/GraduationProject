...
//                Singleton.getInstance().ShowJFXDialogStandart(stackPane, messageBox);
        ...
        String[] arrStr = {"GetPersonalControlList"};
        String tempString = (String) Singleton.getInstance().getDataController().GetPersonalControlList(arrStr);
    ...
    public void OnReload() {
        ...
        //==============================ComboBoxInit======================================
        ObservableList<String> comboList = FXCollections.observableArrayList();
        String[] arrStrControl = {"GetPersonalControlList"};
        String tempString = (String) Singleton.getInstance().getDataController().GetPersonalControlList(arrStrControl);
        tempString = tempString.replaceAll("\r", "");
        String[] resultSet = tempString.split("<<");
        for(String i : resultSet) {
            String[] resultSubSet = i.split(">>");
        ...
        tempString = (String) Singleton.getInstance().getDataController().GetTeamsList(arrStrTeams);
        tempString = tempString.replaceAll("\r", "");
        ...
        //================================/ComboBoxInit======================================
        String[] arrStr = {"GetProjectInfo", projectName};
        //PersonalInfoClass tempString = Singleton.getInstance().getDataController().GetPersonalInfo(arrStr);
        tempString = (String) Singleton.getInstance().getDataController().GetProjectInfo(arrStr);
        tempString = tempString.replaceAll("\r", "");
        resultSet = tempString.split(">>");
        int data_type = 0;
        for(String i: resultSet) {
        ...
        tempString = (String) Singleton.getInstance().getDataController().GetTeamMembersList(arrStrTeamMembers);
        tempString = tempString.replaceAll("\r", "");
        resultSet = tempString.split(">>");
        for(String i : resultSet) {
            comboList.add(i);
